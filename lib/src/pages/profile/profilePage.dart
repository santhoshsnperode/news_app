    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
            ...
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 20),
                  Text('Unlocks Your News Feed...', style: AppTheme.h5Style),
                ],
              )
            ],
          ),
          ...
          Row(
            children: <Widget>[
              _estimateWidget('Followers', '∞'),
              _estimateWidget('Following', '∞'),
              _estimateWidget('News Read', '∞'),
            ],
          ),
          SizedBox(height: 30),
          Divider()
                ...
                slivers: <Widget>[
                  ...
                  SliverToBoxAdapter(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        _settingRow(
                            context, Icons.lightbulb_outline, 'Night', val,index: 1),
